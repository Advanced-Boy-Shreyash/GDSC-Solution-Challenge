...
export 'pay_confirmation_model.dart';
...
class PayConfirmationWidget extends StatefulWidget {
  const PayConfirmationWidget({
    ...
    String? vehicleNo,
  })  : this.vehicleNo = vehicleNo ?? 'MH00AA11',
        super(key: key);
  ...
  @override
  _PayConfirmationWidgetState createState() => _PayConfirmationWidgetState();
}
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Your parking is booked ${widget.vehicleNo} at B2 slot.',
